    ...
    <div class="col-xs-11 col-sm-11 m-auto">
    	...
    	<div class="form1Container">
		    <form class="formStyle1" action="inscription.php<?=($modify)?"?id=".$_GET["id"]:""?>" method="post" autocomplete="on" id="inscr" enctype="multipart/form-data">
		        ...
		        <div class="inputGroup">
		        	<input class="textEffect1" id="fname" name="prenom" type="text" placeholder="Prénom" maxlength="20" pattern="[A-Za-zÀÁÂÃÄÅàáâãäåÒÓÔÕÖØòóôõöøÈÉÊËèéêëÇçÌÍÎÏìíîïÙÚÛÜùúûüÿÑñ._-\'\s]{3,20}" title="3 caractères minimum" value="<?php if(isset($prenom_r)){echo $prenom_r; }?>" required>
