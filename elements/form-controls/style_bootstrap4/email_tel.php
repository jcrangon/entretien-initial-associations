    	...
    	<div class="form1Container">
		    <form class="formStyle1" action="inscription.php<?=($modify)?"?id=".$_GET["id"]:""?>" method="post" autocomplete="on" id="inscr" enctype="multipart/form-data">
				...
				<div class="form-group">
		        	...
		        	<input type="email" class="form-control" id="mail" name="email" pattern="[A-Za-z0-9._%+-]{1,}@[a-zA-Z]{1,}([.]{1}[a-zA-Z]{2,}|[.]{1}[a-zA-Z]{2,}[.]{1}[a-zA-Z]{2,})"value="<?=$email_r ?>" aria-describedby="Email" placeholder="Email" required>
		        ...
		        <div class="form-group">
		        	...
		        	<input type="number" class="form-control" id="telph" min="0" max="9999999999"  name="telmob" pattern="[0-9]{10}" value="<?=$tel_r ?>" aria-describedby="telephone mobile" placeholder="Tel.portable" required>
		            <span class="fieldError"><?php if(isset($error["telmob"])){ echo $error["telmob"]; } ?></span>
		        </div>
		        
		        <div class="form-group">
		        	<label for="telph">Tel.Fixe</label>
		        	<input type="number" class="form-control" id="telph" min="0" max="9999999999"  name="telfixe" pattern="[0-9]{10}" value="<?=$tel_r ?>" aria-describedby="telephone fixe" placeholder="Tel.Fixe" > <!-- CHAMPS NON OBLIGATOIRE -->
